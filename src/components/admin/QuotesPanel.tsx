                    ...
                    <div className="flex items-start justify-between">
                      <div>
                        <div className="flex items-center gap-3 mb-1">
                          <span className="text-sm font-mono text-muted-foreground">{formatId(quote.id)}</span>
                          <Badge variant="outline" className={`${getStatusColor(quote.status)} flex items-center gap-1`}>
                  ...
                  <div className="flex md:flex-col gap-2">
                    ...
                    >
                      ...
                      <DialogContent className="sm:max-w-[600px]">
                        <DialogHeader>
                          ...
                          <DialogDescription>Request ID: {formatId(quote.id)}</DialogDescription>
                        </DialogHeader>
                        <div className="space-y-4">
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2">
                              <Label>Status</Label>
                              <Badge variant="outline" className={`${getStatusColor(quote.status)} flex items-center gap-1 w-fit`}>
                                {getStatusIcon(quote.status)}
                                {quote.status}
                              </Badge>
                            </div>
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        {quote.status === "pending" && (
                          <>
                            <DropdownMenuItem onClick={() => updateStatusMutation.mutate({ id: quote.id, status: "processed" })}>
                        ...
                        {quote.status !== "pending" && (
                          <DropdownMenuItem onClick={() => updateStatusMutation.mutate({ id: quote.id, status: "pending" })}>
                            <Clock className="h-4 w-4 mr-2" />
                            Mark as Pending
                          </DropdownMenuItem>
                        )}
                        <DropdownMenuItem className="text-red-600" onClick={() => deleteMutation.mutate(quote.id)}>
                          Delete
                        </DropdownMenuItem>
                      </DropdownMenuContent>
                    </DropdownMenu>
